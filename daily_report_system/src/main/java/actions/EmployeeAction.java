    ...
    public void update() throws ServletException, IOException {
        ...
        if (checkAdmin() && checkToken()) { // 追記
            ...
            EmployeeView ev = new EmployeeView(toNumber(getRequestParam(AttributeConst.EMP_ID)),
                    getRequestParam(AttributeConst.EMP_CODE), getRequestParam(AttributeConst.EMP_NAME),
                    getRequestParam(AttributeConst.EMP_PASS), toNumber(getRequestParam(AttributeConst.EMP_ADMIN_FLG)),
